...
class CreateEquiposTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('extintors', function (Blueprint $table) {
            ...
            $table->timestamp('vencimiento_carga')->default(DB::raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'));
            $table->timestamp('vencimiento_ph')->default(DB::raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'));
